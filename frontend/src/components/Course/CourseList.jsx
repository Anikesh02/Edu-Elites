...
class CourseList extends React.Component {
  ...
  render() {
    return (
      <div className="w-[100%] h-[80vh] mt-10 absolute">
        <div
        ...
        <div className="w-[100%] h-[80vh] flex justify-center items-center">
          {
            <CourseCard
              doctor1={doctors[this.state.idx - 1]}
              doctor2={doctors[this.state.idx]}
              doctor3={doctors[this.state.idx + 1]}
            />
          }
          <div className="w-[500px] h-3 top-[750px] absolute justify-center items-center gap-[15px] inline-flex">
